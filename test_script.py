    ...
    if req_type=="code":
        with io.StringIO() as buf, redirect_stdout(buf):
            ...
            if code_type==FUNC_TYPE:
                ...
                # execution test
                output=execution_test(f,args,kwargs,globals(),locals(),buf,code_type)
                ...
                if hasattr(instance,"__call__"):
                    output=execution_test(instance.__call__, i_args, i_kwargs, globals(), locals(), buf,code_type)
            ...
            test_output={"error_code":SUCCESS,\
